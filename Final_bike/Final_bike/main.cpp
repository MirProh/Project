...
int main()
{
    ...
    sf::Texture t;
    t.loadFromFile("../Final_bike/bike1.png");
    bike.setTexture(t);
    ...
    sf::Texture wheelt;
    wheelt.loadFromFile("../Final_bike/Wheel.png");
    ...
    while (window.isOpen())
    {
        ...
        sf::RectangleShape springr(sf::Vector2f(b.rear.s.len(), 5));//отрисовка передней и задней рессоры
